...
export class AddUserPartnerRelation1681000000001 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "users" ADD CONSTRAINT "UQ_users_partner_id" UNIQUE ("partner_id")`,
    );
    await queryRunner.query(
      `ALTER TABLE "users" ADD CONSTRAINT "FK_users_partner_id" FOREIGN KEY ("partner_id") REFERENCES "affiliate_partners"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
  }

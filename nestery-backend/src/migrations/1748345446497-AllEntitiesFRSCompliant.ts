...
export class AllEntitiesFRSCompliant1748345446497 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."properties_property_type_enum" AS ENUM('hotel', 'apartment', 'resort', 'villa', 'hostel', 'guesthouse')`);
        await queryRunner.query(`ALTER TABLE "properties" ADD "property_type" "public"."properties_property_type_enum" NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "properties" ADD "thumbnail_image" character varying(255)`);
        await queryRunner.query(`CREATE TYPE "public"."properties_source_type_enum" AS ENUM('internal', 'booking', 'oyo')`);
        await queryRunner.query(`ALTER TABLE "properties" ADD "source_type" "public"."properties_source_type_enum" NOT NULL DEFAULT 'internal'`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."users_loyalty_tier_enum" AS ENUM('bronze', 'silver', 'gold', 'platinum')`);
        await queryRunner.query(`ALTER TABLE "users" ADD "loyalty_tier" "public"."users_loyalty_tier_enum" NOT NULL DEFAULT 'bronze'`);
        await queryRunner.query(`ALTER TABLE "users" ADD "loyalty_points" integer NOT NULL DEFAULT '0'`);
        ...
        await queryRunner.query(`ALTER TABLE "bookings" ADD "confirmation_code" character varying(50) NOT NULL`);
        await queryRunner.query(`ALTER TABLE "bookings" ADD "special_requests" text`);
        await queryRunner.query(`CREATE TYPE "public"."bookings_payment_method_enum" AS ENUM('credit_card', 'paypal', 'points')`);
        await queryRunner.query(`ALTER TABLE "bookings" ADD "payment_method" "public"."bookings_payment_method_enum" NOT NULL`);
        await queryRunner.query(`ALTER TABLE "bookings" ADD "payment_details" jsonb`);
        await queryRunner.query(`ALTER TABLE "bookings" ADD "loyalty_points_earned" integer NOT NULL DEFAULT '0'`);
        await queryRunner.query(`CREATE TYPE "public"."bookings_source_type_enum" AS ENUM('internal', 'booking', 'oyo')`);
        await queryRunner.query(`ALTER TABLE "bookings" ADD "source_type" "public"."bookings_source_type_enum" NOT NULL DEFAULT 'internal'`);
        await queryRunner.query(`ALTER TABLE "bookings" ADD "external_booking_id" character varying(100)`);
        await queryRunner.query(`ALTER TABLE "bookings" ADD "supplier_id" character varying`);
        await queryRunner.query(`ALTER TABLE "bookings" ADD "supplier_booking_reference" character varying(100)`);
        await queryRunner.query(`ALTER TABLE "bookings" ADD "created_at" TIMESTAMP NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "bookings" ADD "updated_at" TIMESTAMP NOT NULL DEFAULT now()`);
        ...
        await queryRunner.query(`ALTER TABLE "properties" ADD "address" character varying(255) NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "properties" ADD "country" character varying(100) NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "bookings" ADD "currency" character varying(3) NOT NULL DEFAULT 'USD'`);
        await queryRunner.query(`ALTER TABLE "bookings" DROP COLUMN "status"`);
        await queryRunner.query(`CREATE TYPE "public"."bookings_status_enum" AS ENUM('confirmed', 'completed', 'cancelled')`);
        await queryRunner.query(`ALTER TABLE "bookings" ADD "status" "public"."bookings_status_enum" NOT NULL DEFAULT 'confirmed'`);
        await queryRunner.query(`ALTER TABLE "property_availability" ADD CONSTRAINT "FK_99aeda8d8fbf9d6efb929db36d2" FOREIGN KEY ("property_id") REFERENCES "properties"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "supplier_properties" ADD CONSTRAINT "FK_32fff33d5dbbfeaee2838968b2a" FOREIGN KEY ("supplier_id") REFERENCES "suppliers"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "supplier_properties" ADD CONSTRAINT "FK_35aa79fcea09998c4840fd73736" FOREIGN KEY ("nestery_master_property_id") REFERENCES "nestery_master_properties"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "premium_subscriptions" ADD CONSTRAINT "FK_44be65c9f19bbb36772b6657520" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "user_recommendations" ADD CONSTRAINT "FK_b65c00f26f1cceff8a096abdf6f" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "user_recommendations" ADD CONSTRAINT "FK_ed73e10cdebf9b6fede57a3277b" FOREIGN KEY ("property_id") REFERENCES "properties"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "social_shares" ADD CONSTRAINT "FK_c3ef34eadf6e80f40c330292b20" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "social_shares" ADD CONSTRAINT "FK_802b3b9cd4b26c267f4b4aa80d3" FOREIGN KEY ("property_id") REFERENCES "properties"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "price_predictions" ADD CONSTRAINT "FK_261ed3c3edf88dcd32b72080541" FOREIGN KEY ("property_id") REFERENCES "properties"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "loyalty_transactions" ADD CONSTRAINT "FK_c4d462b2bc48d9304b31bcab46b" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "itineraries" ADD CONSTRAINT "FK_2c1f9990ff4b57b054ed85a45e6" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "loyalty_points_ledger" ADD CONSTRAINT "FK_31118d1b0215166324667b678d0" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "itinerary_items" ADD CONSTRAINT "FK_6f8232dfb944b7628c7ae781ce6" FOREIGN KEY ("itinerary_id") REFERENCES "itineraries"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "itinerary_items" ADD CONSTRAINT "FK_fa41ef3d6b21c97cca2c5009b2a" FOREIGN KEY ("property_id") REFERENCES "properties"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "loyalty_redemptions" ADD CONSTRAINT "FK_e223a4449ae69f109776d49a60d" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "loyalty_redemptions" ADD CONSTRAINT "FK_09d6bed25a55b92b2de4c913f8d" FOREIGN KEY ("reward_id") REFERENCES "loyalty_rewards"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "loyalty_redemptions" DROP CONSTRAINT "FK_09d6bed25a55b92b2de4c913f8d"`);
        await queryRunner.query(`ALTER TABLE "loyalty_redemptions" DROP CONSTRAINT "FK_e223a4449ae69f109776d49a60d"`);
        await queryRunner.query(`ALTER TABLE "itinerary_items" DROP CONSTRAINT "FK_fa41ef3d6b21c97cca2c5009b2a"`);
        await queryRunner.query(`ALTER TABLE "itinerary_items" DROP CONSTRAINT "FK_6f8232dfb944b7628c7ae781ce6"`);
        await queryRunner.query(`ALTER TABLE "loyalty_points_ledger" DROP CONSTRAINT "FK_31118d1b0215166324667b678d0"`);
        ...
        await queryRunner.query(`ALTER TABLE "itineraries" DROP CONSTRAINT "FK_2c1f9990ff4b57b054ed85a45e6"`);
        await queryRunner.query(`ALTER TABLE "loyalty_transactions" DROP CONSTRAINT "FK_a51f0b10d0baf1f83b89cb8b2bc"`);
        await queryRunner.query(`ALTER TABLE "loyalty_transactions" DROP CONSTRAINT "FK_c4d462b2bc48d9304b31bcab46b"`);
        await queryRunner.query(`ALTER TABLE "price_predictions" DROP CONSTRAINT "FK_261ed3c3edf88dcd32b72080541"`);
        await queryRunner.query(`ALTER TABLE "social_shares" DROP CONSTRAINT "FK_802b3b9cd4b26c267f4b4aa80d3"`);
        await queryRunner.query(`ALTER TABLE "social_shares" DROP CONSTRAINT "FK_c3ef34eadf6e80f40c330292b20"`);
        await queryRunner.query(`ALTER TABLE "user_recommendations" DROP CONSTRAINT "FK_ed73e10cdebf9b6fede57a3277b"`);
        await queryRunner.query(`ALTER TABLE "user_recommendations" DROP CONSTRAINT "FK_b65c00f26f1cceff8a096abdf6f"`);
        ...
        await queryRunner.query(`ALTER TABLE "premium_subscriptions" DROP CONSTRAINT "FK_44be65c9f19bbb36772b6657520"`);
        ...
        await queryRunner.query(`ALTER TABLE "supplier_properties" DROP CONSTRAINT "FK_35aa79fcea09998c4840fd73736"`);
        await queryRunner.query(`ALTER TABLE "supplier_properties" DROP CONSTRAINT "FK_32fff33d5dbbfeaee2838968b2a"`);
        await queryRunner.query(`ALTER TABLE "property_availability" DROP CONSTRAINT "FK_99aeda8d8fbf9d6efb929db36d2"`);
        await queryRunner.query(`ALTER TABLE "bookings" DROP COLUMN "status"`);
        ...
        await queryRunner.query(`ALTER TABLE "properties" DROP COLUMN "currency"`);
        await queryRunner.query(`ALTER TABLE "properties" ADD "currency" character varying NOT NULL DEFAULT 'USD'`);
        await queryRunner.query(`ALTER TABLE "properties" DROP COLUMN "longitude"`);
        ...
        await queryRunner.query(`ALTER TABLE "bookings" ADD "isCancelled" boolean NOT NULL DEFAULT false`);
        await queryRunner.query(`ALTER TABLE "bookings" ADD "guest_count" integer NOT NULL`);
        await queryRunner.query(`ALTER TABLE "bookings" ADD "updatedAt" TIMESTAMP NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "bookings" ADD "createdAt" TIMESTAMP NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "bookings" ADD "sourceType" character varying NOT NULL DEFAULT 'direct'`);
        await queryRunner.query(`ALTER TABLE "bookings" ADD "specialRequests" character varying`);
        await queryRunner.query(`ALTER TABLE "bookings" ADD "isPremiumBooking" boolean NOT NULL DEFAULT false`);
        await queryRunner.query(`ALTER TABLE "bookings" ADD "loyaltyPointsRedeemed" integer NOT NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE "bookings" ADD "loyaltyPointsEarned" integer NOT NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE "bookings" ADD "isRefunded" boolean NOT NULL DEFAULT false`);
        ...
        await queryRunner.query(`ALTER TABLE "users" ADD "hasCompletedBooking" boolean NOT NULL DEFAULT false`);
        ...
        await queryRunner.query(`ALTER TABLE "properties" ADD "reviewCount" integer NOT NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE "properties" ADD "rating" double precision`);
        await queryRunner.query(`ALTER TABLE "properties" ADD "pricePerNight" double precision NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "bookings" ADD CONSTRAINT "FK_cf064476d403971270369232d80" FOREIGN KEY ("propertyId") REFERENCES "properties"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "users" ADD CONSTRAINT "FK_d3998945517e0cac384f573b3cb" FOREIGN KEY ("referredBy") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
